...
FEEDS = {
    ...
    **{symbol: crypto_feed(symbol) for symbol in DEFAULT_CRYPTO_UNIVERSE},
    "XAU": AssetFeed(
        ...
        provider_name="Dukascopy Public Datafeed",
        provider_symbol="XAUUSD",
        terms_url="https://www.dukascopy.com/swiss/english/marketwatch/historical/",
        client_provider="dukascopy-python",
        upstream_provider="dukascopy",
        naive_timezone="UTC",
    ),
}
