...
const SOURCE_POLICIES = [
  ...
  {
    sourceCode: "wgc-central-bank",
    sourceName: "World Gold Council Gold Reserves",
    market: "gold",
    collectionMode: "firecrawl",
    parserVersion: "wgc-central-bank-v1",
    freshnessSlaMinutes: 172_800,
  },
  {
    sourceCode: "wgc-gold-etf",
    sourceName: "World Gold Council ETF Holdings and Flows",
    market: "gold",
    collectionMode: "firecrawl",
    parserVersion: "wgc-etf-v1",
    freshnessSlaMinutes: 20_160,
  },
